...
messages = [
  {
    "role": "system", 
    "content": "Eres un asistente que SIEMPRE debe usar los resultados de las herramientas disponibles. Cuando una herramienta te proporcione información, DEBES usar esa información en tu respuesta. NUNCA digas que no tienes acceso a información en tiempo real si una herramienta te ha proporcionado datos."
  },
  {
    "role": "user", 
